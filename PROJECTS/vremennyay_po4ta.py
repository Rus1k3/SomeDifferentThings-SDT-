...
def check_mail(mail=''):
    ...
    if length == 0:
        print('На почте нет новых сообщений. Проверка происходит каждые 5 секунд')
    else:
        id_list = []
        ...
        print(f'У вас {length} входящих Почта обновляется  каждые 5 секунд')
...
def main():
    try:
        ...
        print('Остановка завершения программы...')
